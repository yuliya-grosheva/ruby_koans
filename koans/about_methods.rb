...
class AboutMethods < Neo::Koan
  ...
  # (NOTE: We are Using eval below b ecause the example code is
  ...
  def test_calling_methods_in_same_class_with_explicit_receiver
    assert_equal 12, self.my_method_in_the_same_class(3,4) # self - явный получатель
  end
  ...
  def test_calling_methods_in_other_objects_require_explicit_receiver
    rover = Dog.new
    assert_equal "Fido", rover.name # вызов публичного метода
  end
